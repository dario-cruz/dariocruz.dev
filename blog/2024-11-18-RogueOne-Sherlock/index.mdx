...
description: HTB Sherlock RogueOne investigation focused on memory forensics and C2 analysis.
keywords: [Hack The Box, Sherlock, RogueOne, memory forensics, Volatility]
